...
def test_solve_premier_sudoku():
    s = Sudoku.load_file(os.path.join(_test_dir, 'premier.sud'))
    s.solve()
    correct_solution = Sudoku.load_file(os.path.join(_test_dir, 'premier_sol.sud'))
