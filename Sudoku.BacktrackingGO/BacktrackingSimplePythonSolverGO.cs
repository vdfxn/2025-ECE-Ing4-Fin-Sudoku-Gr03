...
namespace Sudoku.BacktrackingGO;

public class BacktrackingSimplePythonSolverGO : PythonSolverBase

	{
		public override Shared.SudokuGrid Solve(Shared.SudokuGrid s)
		{
			...
			using (PyModule scope = Py.CreateScope())
			{
				...
				string code = System.IO.File.ReadAllText("BacktrackingSimpleSolver.py");
				scope.Exec(code);
